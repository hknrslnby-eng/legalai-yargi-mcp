...
def default_source_registry() -> SourceRegistry:
    return SourceRegistry([
        ...
        SourceDescriptor("competition_reports", "Rekabet ve piyasa raporları", "reports", 75, status="live_ready", authority_level="non_binding_economic_reference", source_kind="economic_report", allowed_contexts=("competition_research", "economic_analysis"), metadata={"precedential": False, "role": "economic_factual_support"}),
