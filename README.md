...
SocratLegal (yerel paket adi geriye donuk uyumluluk icin `legalai`) yerel STDIO MCP sunucusudur. Normal kullanici [portable kurulum rehberini](docs/socratlegal-user-install.md) izler; Python/uv/hosting kurmasi gerekmez. MCP'ye baglandiktan sonra kullanici arac adlarini ezberlemeden dogal dilde istekte bulunabilir veya `socratlegal_yardim` aracindan mevcut yetenekleri ve ornek promptlari alabilir. Manuel IDE ayarlari icin [docs/mcp-client-setup.md](docs/mcp-client-setup.md) dosyasina bakin.
